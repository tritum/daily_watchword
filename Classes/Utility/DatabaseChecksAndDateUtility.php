...
class DatabaseChecksAndDateUtility implements \TYPO3\CMS\Core\SingletonInterface
{
    /**
     * @var string
     */
    ...
    /**
     * DatabaseChecksAndDateUtility constructor.
     */
     ...
     * @return bool
     */
    public function checkIfDateExitsInDB()
    {
